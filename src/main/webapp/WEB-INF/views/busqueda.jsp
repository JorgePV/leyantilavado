			...
			<div class="panel panel-info">
				...
				<div class="panel-body">
					...
					<table class="table table-bordered" id="tblReporte">
						...
						<tbody>
						<c:forEach var="clienteX" items="${lista}" >
							<tr>
								<td scope="row">#</td>
								<td>${clienteX.periodo}</td>
								<td>${clienteX.clienteid}</td>
								<td>${clienteX.linea}</td>
								<td>${clienteX.tarjeta}</td>
								<td>${clienteX.tipocliente}</td>
								<td>${clienteX.nombre}</td>
								<td>${clienteX.rfc}</td>
								<td>${clienteX.montogasto}</td>
								<td>${clienteX.estatusid}</td>
								<td>${clienteX.tipoidentificacion}</td>
							</tr>
						</c:forEach>
						</tbody>
					</table>
